...
<div class="section">
  <TitlePage id="sec-introduction" title="Introduction" />
  ...
  <div class="section">
    <TitlePage id="getting-started" title="Getting Started" level={2} />
  ...
  <div class="section">
    <TitlePage id="sec-configuration" title="Configuration" level={2} />
  ...
  <div class="section">
    <TitlePage id="sec-legcord" title="Legcord" level={2} />
  ...
  <div class="section">
    <TitlePage id="sec-user-plugins" title="Third-Party User Plugins" level={2} />
  ...
  <div class="section">
    <TitlePage id="sec-dorion" title="A Note on Dorion" level={2} />
