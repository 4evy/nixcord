...
export const linkClass =
  `text-[#0a3e68] underline underline-offset-2 decoration-[1px] hover:text-[#268598] ${focusClass}`;
...
export const literalCodeClass =
  'rounded bg-neutral-100 px-1 py-0.5 font-mono text-[0.92em] text-neutral-900 [overflow-wrap:anywhere]';

export const optionCodeClass =
  'bg-transparent px-0 py-0 font-mono text-[1rem] font-semibold text-[#0a3e68] [overflow-wrap:anywhere]';
...
export const topSectionClass =
  'section mt-10 border-t border-neutral-300 pt-7 [&>header:first-child_h2]:mt-0';
