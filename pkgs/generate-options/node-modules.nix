...
let
  hashes = {
    x86_64-linux = "sha256-OdlcCaPt/SlJQkkK+iiNZ0INmShcQQBoCBTPp03tmlk=";
    aarch64-linux = "sha256-JUwJQA5ja3Mv92hfc39YipieLiQsiYdnROLGs5qHVfE=";
    aarch64-darwin = "sha256-rUznpludSs3pigcgxm7H0ChHlKZfdvyTZF+RDHHljGM=";
  };
  hash =
