...
let
  hashes = {
    x86_64-linux = "sha256-LFSZJ+GC1dsqeQ8egL47ef+GCDaVd9JqF2lgDOhAd4U=";
    aarch64-linux = "sha256-cvxHmY0Y4r0u6xIY8e7SSugnBhW8LyNg0kE/jcRDMYg=";
    aarch64-darwin = "sha256-Rb0V7x55X19F5j4LnRve8TxMxA5+B7m5PA3A0KW/Wds=";
  };
  hash =
