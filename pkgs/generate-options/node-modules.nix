...
let
  hashes = {
    x86_64-linux = "sha256-MNNgkhNLx4WJddhiyWHuYiYaWFaGHcQqPmycDwX0Sto=";
    aarch64-linux = "sha256-KJQZPxS+8gnQENglZSHen+PDR8w/wFAsbopLnIt1Ssg=";
    aarch64-darwin = "sha256-AhoM2WVhbWjm0FhpK/hmRz1IVDYNIr+QkwukpKoCdW4=";
  };
  hash =
