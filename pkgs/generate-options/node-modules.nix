...
let
  hashes = {
    x86_64-linux = "sha256-Ko36LuDNaUXYbXMVjvEEfhWYPhyNg1+0/IUn+AuIfyg=";
    aarch64-linux = "sha256-5EAVU0TsaPRlIi1xSsuP0ePZ4/75lPAFpVPltr8uas0=";
    aarch64-darwin = "sha256-m2Qka2V2RtBmkFzvy0uzWQMOJjNkaw4eT3mRGzUW84M=";
  };
  hash =
