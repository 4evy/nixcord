...
let
  hashes = {
    x86_64-linux = "sha256-nHVMfJ76KG8KDK2QRnPAOYFa4zwyGZrlHwbGu7qAYmI=";
    aarch64-linux = "sha256-BZOJnpfclJNerxCtyRSrhRAYZgLB3bRmoW6sAPIbwXQ=";
    aarch64-darwin = "sha256-0QJp5y9u9/l3kxr+jLPy0EBeXpPBmLFpixXtOpL3vrI=";
  };
  hash =
