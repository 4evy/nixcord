...
let
  hashes = {
    x86_64-linux = "sha256-Fk8P0bgn33mSBMvXayPqPGuw8C+qkOeb5Fjhw4kjVzI=";
    aarch64-linux = "sha256-XyLdOY1S1CVn3G8dzPRuTQcaz9pY/Nwwu5rKY8TjQEw=";
    aarch64-darwin = "sha256-o0ncSeL0D+nloic85roGd/UboZxCEJpKdA8p/Y2KmUs=";
  };
  hash =
