...
let
  hashes = {
    x86_64-linux = "sha256-JInDgHuIQkFlAvROoBx7MIyNBfLSdxYDGJ3mI1Kzi2U=";
    aarch64-linux = "sha256-HUUti62qnW5ZtG/n4q7ifAquivgUMSbs9/AlLN44AXE=";
    aarch64-darwin = "sha256-bRTzb5/0gtBIiDKJx2ZR2ABNh5SbI2+IUJHiiRlFufk=";
  };
  hash =
