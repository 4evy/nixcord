...
let
  hashes = {
    x86_64-linux = "sha256-wgWmjVL55NJTwMj9BpCYB+yeopG/78C7euYTmtJpnMU=";
    aarch64-linux = "sha256-QLqE6lWVhi9l+x89fxmeInZAHH+5WL9dJON6LX1fY6Q=";
    aarch64-darwin = "sha256-alwir+PXPH3+K+BVAZK5onneOHLeDl3MT/Cpk5wYrAY=";
  };
  hash =
