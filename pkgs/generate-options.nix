...
let
  nodeModulesHashes = {
    ...
    aarch64-linux = "sha256-5oTM07wTW/lJjDRIOqulD5ym4E5zUE2MdXuhUrYLOLo=";
    aarch64-darwin = "sha256-IIYDGK9MBjcsyq/zOkyaK3m7Ihi172cveDtrAqvNAWE=";
    x86_64-darwin = "sha256-FKP4oC8gu5KXG0ZtL9gXtFrXDRE4Vumg/CyCFSSIIoI=";
  };
  nodeModulesHash =
