...
let
  nodeModulesHashes = {
    ...
    aarch64-linux = "sha256-CudRnjntDvcEByWSh6abLkak5H89zcHWs2PxnYin+mM=";
    aarch64-darwin = "sha256-hau34b0ASd4EKD0zT74ys4SB8LDaqxDnwI9x5rA/0oE=";
    x86_64-darwin = "sha256-NDgh/q1lkkRrb/IxoOvlfZGUWzobHUVrYz4mraTGMqo=";
  };
  nodeModulesHash =
