...
let
  nodeModulesHashes = {
    ...
    aarch64-linux = "sha256-tlN0kyZM2bA+faRYTjFxtAolb8m6kHwEqUm8DmhoGXM=";
    aarch64-darwin = "sha256-XrI2xDVVpt2XSXHGj+m5rM92zmXab1fjj7NlnGzTVVA=";
    x86_64-darwin = "sha256-BA3/chXpFlEXp9IhIQnhmuNPicWNSN9ZgDTXBXtUYvo=";
  };
  nodeModulesHash =
