...
let
  nodeModulesHashes = {
    ...
    aarch64-linux = "sha256-8hcszylGY7oPg3548eJnC5zePB8jyykdWGjf3wrWg+w=";
    aarch64-darwin = "sha256-YcHyFHaiJek1Jg69D0QbgrxcRjmHZOYqT2tQ4JbrsvE=";
    x86_64-darwin = "sha256-bpfYDYAAf3wKhiqxAB3uJ7/V2xesJSCaRWabzKZxJUY=";
  };
  nodeModulesHash =
