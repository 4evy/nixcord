...
let
  nodeModulesHashes = {
    ...
    aarch64-linux = "sha256-RpukzWoFd7N6xt8ZmmjPDPr/uh/Xg9d8DfroQx6KyfA=";
    aarch64-darwin = "sha256-pBPQ6fwyyBHdf+3HKpq9UkJjcm2ppzmFqDVm0JO5te0=";
    x86_64-darwin = "sha256-61gXHWo/vv9Is+FtDzDC3Jh8CWwp954SOhWn1Aad55A=";
  };
  nodeModulesHash =
