...
let
  nodeModulesHashes = {
    x86_64-linux = "sha256-ztkWPMOcBi5bDyzJ5KQ8yq4T6ynEFNg091IJtunh4VM=";
    aarch64-linux = "sha256-We1l0L+9sOorwb5eOfoa0QMGdyX9g/ku16ixxw6qPzc=";
    aarch64-darwin = "sha256-q4j2th1eLUrxtamDB0E7ytTKMjGNWGX6oVNhgLZaE+w=";
  };
  nodeModulesHash =
