...
let
  nodeModulesHashes = {
    x86_64-linux = "sha256-eHGpf9/Ib6a+UDbFzYTPYC/j+jqypKkvAB/qFWq2GZ0=";
    aarch64-linux = "sha256-nmKq/2soonSq2+qvzbWfHeqv2SEL5nWdCQKJUBtMbV8=";
    aarch64-darwin = "sha256-rTYjE7KJc7RbjmcztTthSgl7tY8AbZy6HpxMgHdcbQg=";
  };
  nodeModulesHash =
