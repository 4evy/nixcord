...
let
  nodeModulesHashes = {
    ...
    aarch64-linux = "sha256-9mruU4uaIG/RE+F6A5USPF+RZvRJbB9J4lN+r5us/FU=";
    aarch64-darwin = "sha256-l5xu39km++72t6QksAELWCWwL8xr4gu1GrYOKbey40g=";
    x86_64-darwin = "sha256-Rlafyu7OLrMMOUPrcz8/vIQ5PDNJafbzMB1emXtI/og=";
  };
  nodeModulesHash =
