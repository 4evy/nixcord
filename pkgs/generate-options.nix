...
let
  nodeModulesHashes = {
    x86_64-linux = "sha256-MLps+gjzDboWWNZnZ/VqPC8TuOvX9PkvIiJF9lHC7Eg=";
    aarch64-linux = "sha256-T9TpfzqzcnJChjIRKjA42Ok8JOpc3HoFsc7bIXl5yZc=";
    aarch64-darwin = "sha256-W0su9ONYCKSSPvSwZOlQ2UtMKnZLPROZZQVzRt+wC0Q=";
  };
  nodeModulesHash =
