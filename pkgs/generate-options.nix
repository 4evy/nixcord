...
let
  nodeModulesHashes = {
    x86_64-linux = "sha256-CTZQNhmEfWwx71L+oHNn5JaJyPjw6lwbYW//nSN1JK8=";
    aarch64-linux = "sha256-pM26PHKtspng5WkcdX+B6xew9MqTa4hbpHvrsVt1WQc=";
    aarch64-darwin = "sha256-VCrdJiRQp1cSCRsgvjg4x8wg/wd0vjtbt2o/JZIFOkk=";
  };
  nodeModulesHash =
